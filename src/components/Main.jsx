...
function Main() {
  return (
    <>
          ...
          <div className="judul text-center md:text-left">
            ...
            <div className="flex justify-center mt-10">
              <a
                ...
                className="default text-white bg-green-600 rounded-full p-4"
              >
                Hubungi Kami
              </a>
            </div>
      ...
      <div className="p-4 mt-9 bg-green-500">
        <h1 className="text-2xl font-bold mb-4 text-center mt-10 text-white">Tentang Pondok Pesantren Putri Djalaludin</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
          <div className="bg-white shadow-md rounded-lg p-4 mt-6 shadow-lg max-w-xl mx-auto">
            <h2 className="text-xl font-bold mb-2">Apa Itu Pondok Pesantren Djalaludin ?</h2>
            <p className="text-justify">
              Pondok Pesantren Djalaluddin Adalah Pondok Pesantren Tahfizh Dan Adab 
              Yang Berbasis Sains Dan Teknologi. Pondok Pesantren Djalaluddin
              Juga Mendapatkan Predikat Sebagai Pesantren Ramah Anak Yang
              Terbebas Dari Bullying, Kekerasan, Dan Pelecehan Seksual.
            </p>
          </div>
          <div className="bg-white shadow-md rounded-lg p-4 mt-6 shadow-lg max-w-xl mx-auto">
        ...
        <div className="bg-white shadow-md rounded-lg p-4 mt-6 shadow-lg mx-auto max-w-xl">
        ...
        <section className="flex flex-col md:flex-row justify-center items-center gap-4">
          ...
          <div className="fotoProgram bg-orange-200 card p-4 shadow-lg rounded-md">
            <img
              ...
              className="featured-image rounded-lg mb-2"
            />
            <h2 className="text-xl text-green-700">Bahasa <br/> Arab dan Inggris</h2>
          </div>
          <div className="fotoProgram bg-orange-200 card p-4 shadow-lg rounded-md">
            <img
              src={tik}
              ...
              className="featured-image rounded-lg mb-2"
            />
            <h2 className="text-xl text-green-700">Keterampilan Keputrian dan TIK</h2>
          </div>
        </section>
      </div>
      <div>
