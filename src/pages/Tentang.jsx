    ...
    <>
      <div className="bg-teal-600 p-8 md:p-40 mx-auto flex flex-col items-center">
        <motion.div
          ...
          className="logo flex flex-col md:flex-row items-center bg-white p-4 md:p-8 rounded-md shadow-lg mb-8"
        >
        ...
        <motion.div
          ...
          className="container text-lg text-justify bg-white pt-6 pb-6 px-8 shadow-md md:pt-8 md:pb-8 md:px-20 rounded-lg"
        >
          <p className="text-teal-600 font-semibold leading-relaxed">
          ...
          <p className="text-teal-600 font-semibold leading-relaxed mt-4">
      ...
      <motion.div
        ...
        className="p-8 md:p-20 bg-teal-600"
      >
        <TeamList />
      </motion.div>
    </>
